...
import assets, { userDummyData } from '../assets/allAssets/assets.js'
    ...
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ""}`}>
      ...
      <div className="pb-5">
        ...
        <div className="flex justify-between items-center">
          <img src="/images/logoFull.svg" alt="logo" className="max-w-30" />
          <div className="relative py-2 group">
            <img src="/images/menu.svg" alt="menu" className="max-h-5 cursor-pointer" />
        ...
        <div className="bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5">
          <img src="/images/search.svg" alt="Search" className="w-3" />
